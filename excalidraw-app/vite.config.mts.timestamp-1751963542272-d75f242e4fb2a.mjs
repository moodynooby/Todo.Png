...
var vite_config_default = defineConfig(({ mode }) => {
  ...
  return {
    server: {
      port: Number(envVars.VITE_APP_PORT || 9e3),
      // open the browser
      open: true
    },
